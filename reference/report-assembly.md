...
```bash
# Create folder: $PWD/research/[NNN_][Topic]_Research_[YYYYMMDD]/
...
mkdir -p $PWD/research/[NNN_][Topic]_Research_[YYYYMMDD]
...
- Location: `$PWD/research/[NNN_][Topic]_Research_[YYYYMMDD]/`
